function CGame(oData){
    ...
    this.checkVictory = function(){
		...
		if (_iCurrentLevel < s_aCardsPerLevel.length) {
			...
			_oNextLevelUI.display(_iLevelScore,_iLevelTimeBonus,_iLevelScore+_iLevelTimeBonus,_iScore); 
		}else{
			if(DISABLE_SOUND_MOBILE === false || s_bMobile === false){
	...
	this.nextLevel = function(){
        ...
        //var bg = new createjs.Bitmap(s_oSpriteLibrary.getSprite("bg_" + ((Math.floor(Math.random()*NUM_BACKGROUNDS))+1)));

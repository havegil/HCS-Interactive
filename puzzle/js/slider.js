...
var image1 = new Image(); image1.src = "img/5.jpg";
var image2 = new Image(); image2.src = "img/6.jpg";
var image3 = new Image(); image3.src = "img/7.jpg";
...
function getMouseXY(e) {
	...
	cursor.X -= canvasX;
	cursor.Y -= canvasY;
	console.log("X: "+ cursor.X + "    Y: " + cursor.Y + "  " + canvas.offsetLeft + "    " + $('#img-puzzle').position().left)
}
...
function SliceImage(){
	...
	/* GN The images tends to load at different speed, therefore image with is coming up with a width of zero
...
/*
function doOrientationChange(e) {
	...
	case -90:
		case 90:
				...
				document.getElementById("puzzle-canvas").style.display = "none";
...
$('.button-left').click(function(e){
	externalClickMgr('prev', e);
});
$('.button-preview').click(function(e){
	externalClickMgr('view', e);
});
$('.button-right').click(function(e){
	externalClickMgr('next',e);
});
*/
